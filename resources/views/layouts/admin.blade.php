...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
            ...
            <div class="mx-auto max-w-7xl py-3 px-3 sm:px-6 lg:px-8">
              <div class="flex flex-wrap items-center justify-between">
                <div class="flex w-0 flex-1 items-center">
                  <span class="flex rounded-lg bg-indigo-800 p-2" x-data="{open:true}" x-how="open">
                ...
                <div class="order-2 flex-shrink-0 sm:order-3 sm:ml-3">
                  <button @click.away="open = false"  type="button" class="-mr-1 flex rounded-md p-2 hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-white sm:-mr-2">
        ...
        <div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
            ...
            <div class="flex w-full bg-late-500">
               {{$slot}}
            </div>
        </div>
    </body>
